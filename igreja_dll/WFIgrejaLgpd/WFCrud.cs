...
using WFIgrejaLgpd.Formulario.Pessoa.FormCrudPessoa;
using FinalizarCadastro = WFIgrejaLgpd.Formulario.Celula.FinalizarCadastro;
...
namespace WFIgrejaLgpd
{
    public partial class WFCrud : Form
    {
        ...
        public WFCrud(modelocrud modelo, bool deletar, bool atualizar, bool detalhes)
        {
            ...
            dadoClasse.Location = new System.Drawing.Point(200, 50);
            ...
            dadoMinisteriosPessoa.Location = new System.Drawing.Point(200, 160);
        ...
        private void Proximo_Click(object sender, EventArgs e)
        {
            ...
            if (this is FormCrudMinisterio)
            {
                if (this.GetType().Name == "DadoMinisterio")
                {
                    ...
                    WFIgrejaLgpd.Formulario.Ministerio.PessoasCelulasMinisterio((business.classes.Abstrato.Ministerio)modelo,
                   CondicaoAtualizar, condicaoDeletar, condicaoDetalhes);
                    fn.MdiParent = this.MdiParent;
                    this.Close();
                    fn.Show();
                ...
                {
                    WFIgrejaLgpd.Formulario.Ministerio.FinalizarCadastro fn = new
                    WFIgrejaLgpd.Formulario.Ministerio.FinalizarCadastro((business.classes.Abstrato.Ministerio)modelo,
                   CondicaoAtualizar, condicaoDeletar, condicaoDetalhes);
                    fn.MdiParent = this.MdiParent;
                    this.Close();
                    fn.Show();
