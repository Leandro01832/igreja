...
using WFIgrejaLgpd.DdataGridViews;
...
namespace WFIgrejaLgpd
{
    ...
    public partial class Pesquisar : Form
    {
        public Pesquisar()
        {
            pesquisa = new WFIgrejaLgpd.DdataGridViews.Pesquisar();
            modelo = null;
            
            InitializeComponent();
        }

       WFIgrejaLgpd.DdataGridViews.Pesquisar pesquisa;
        modelocrud modelo;
        string comando = "";
        string tipo = "";
        ...
        private void radio_pessoa_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                var dado = (business.classes.Abstrato.PessoaLgpd)item;
        ...
        {
            comboBox1.Text = "Escolha o tipo se necessário.";
            modelo = new business.classes.ChamadaLgpd();
            ...
            foreach (var item in pesquisa.BuscarPorRestricao(modelo, tipo, comando))
            {
                var dado = (business.classes.ChamadaLgpd)item;
        ...
        private void FormataDataGrid(bool PessoaLgpd, bool Ministerio,
        ...
        private void ModificaDataGridView(modelocrud m, string tipo, string comando)
        {
            ...
            if (m is business.classes.Abstrato.PessoaLgpd)
            {
                if (m is business.classes.PessoasLgpd.VisitanteLgpd)
                {
                    FormataDataGrid(true, false, false, false, false, false);
                ...
                if (m is business.classes.PessoasLgpd.CriancaLgpd)
                {
                    FormataDataGrid(true, false, false, false, false, false);
                ...
                if (m is business.classes.PessoasLgpd.Membro_AclamacaoLgpd)
                {
                    FormataDataGrid(true, false, false, false, false, false);
                ...
                if (m is business.classes.PessoasLgpd.Membro_BatismoLgpd)
                {
                    FormataDataGrid(true, false, false, false, false, false);
                    dgdados.Columns.Add("Data_batismo", "ano do batismo");
                    dgdados.Columns.Add("Desligamento", "Desligamento");
                ...
                if (m is business.classes.PessoasLgpd.Membro_ReconciliacaoLgpd)
                {
                    FormataDataGrid(true, false, false, false, false, false);
                    dgdados.Columns.Add("Data_batismo", "ano do batismo");
                    dgdados.Columns.Add("Desligamento", "Desligamento");
            ...
            foreach (var item in pesquisa.BuscarPorRestricao(m, tipo, comando))
            {
                if (m is business.classes.Abstrato.PessoaLgpd)
                {
                    if (m is business.classes.PessoasLgpd.VisitanteLgpd)
                    {
                        business.classes.PessoasLgpd.VisitanteLgpd info = (business.classes.PessoasLgpd.VisitanteLgpd)item;
                    ...
                    if (m is business.classes.PessoasLgpd.CriancaLgpd)
                    {
                        business.classes.PessoasLgpd.CriancaLgpd info = (business.classes.PessoasLgpd.CriancaLgpd)item;
                        dgdados.Rows.Add(info.Id, info.Email, info.celula_, info.Falta, info.Img,
                    ...
                    if (m is business.classes.PessoasLgpd.Membro_AclamacaoLgpd)
                    {
                        business.classes.PessoasLgpd.Membro_AclamacaoLgpd info = (business.classes.PessoasLgpd.Membro_AclamacaoLgpd)item;
                        dgdados.Rows.Add(info.Id, info.Email, info.celula_, info.Falta, info.Img,
                    ...
                    if (m is business.classes.PessoasLgpd.Membro_BatismoLgpd)
                    {
                        business.classes.PessoasLgpd.Membro_BatismoLgpd info = (business.classes.PessoasLgpd.Membro_BatismoLgpd)item;
                        dgdados.Rows.Add(info.Id, info.Email, info.celula_, info.Falta, info.Img,
                    ...
                    if (m is business.classes.PessoasLgpd.Membro_ReconciliacaoLgpd)
                    {
                        business.classes.PessoasLgpd.Membro_ReconciliacaoLgpd info = (business.classes.PessoasLgpd.Membro_ReconciliacaoLgpd)item;
                        dgdados.Rows.Add(info.Id, info.Email, info.celula_, info.Falta, info.Img,
                        info.Data_batismo, info.Desligamento, info.Motivo_desligamento, info.Data_reconciliacao);
                    }

                    if (m is business.classes.PessoasLgpd.Membro_TransferenciaLgpd)
                    {
                        business.classes.PessoasLgpd.Membro_TransferenciaLgpd info = (business.classes.PessoasLgpd.Membro_TransferenciaLgpd)item;
                        dgdados.Rows.Add(info.Id, info.Email, info.celula_, info.Falta, info.Img,
