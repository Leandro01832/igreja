...
using WFIgrejaLgpd.Formulario.Celula;
using WFIgrejaLgpd.Formulario.Ministerio;
...
namespace WFIgrejaLgpd
{
    public partial class MDI : Form
    {
        ...
        {
            DadoPessoal cma = 
                new DadoPessoal(new business.classes.PessoasLgpd.Membro_AclamacaoLgpd(), false, false, false);
            cma.MdiParent = this;
        ...
        {
            DadoPessoal cmb =
            new DadoPessoal(new business.classes.PessoasLgpd.Membro_BatismoLgpd(), false, false, false);
            cmb.MdiParent = this;
        ...
        {
            DadoPessoal cmr =
            new DadoPessoal(new business.classes.PessoasLgpd.Membro_ReconciliacaoLgpd(), false, false, false);
            cmr.MdiParent = this;
        ...
        {
            DadoPessoal cmt = 
            new DadoPessoal(new business.classes.PessoasLgpd.Membro_TransferenciaLgpd(), false, false, false);
            cmt.MdiParent = this;
        ...
        {
            DadoPessoal cv =
            new DadoPessoal(new business.classes.PessoasLgpd.VisitanteLgpd(), false, false, false);
            cv.MdiParent = this;
        ...
        {
            DadoPessoal cc =
            new DadoPessoal(new business.classes.PessoasLgpd.CriancaLgpd(), false, false, false);
            cc.MdiParent = this;
        ...
        {
            ImprimirRelatorio ir = new ImprimirRelatorio();
            ir.imprimir(new business.classes.Reuniao(), "");
        }
        ...
        {
            ImprimirRelatorio ir = new ImprimirRelatorio();
            ir.imprimir(new business.classes.Historico(), "");
        }
    }
}
