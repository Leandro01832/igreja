...
namespace WindowsFormsApp1
{
    public partial class FormProcessamento :  FormPadrao
    {
        ...
        {
            if (modelocrud.Modelos.OfType<Visitante               >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Crianca)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Criança"; form.Show(); }
            if (modelocrud.Modelos.OfType<Crianca                 >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Visitante)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Visitante"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_Aclamacao        >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_Aclamacao)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Aclamação"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_Batismo          >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_Batismo)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por batismo"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_Reconciliacao    >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_Reconciliacao)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Reconciliação"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_Transferencia    >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_Transferencia)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Transferencia"; form.Show(); }
            if (modelocrud.Modelos.OfType<VisitanteLgpd           >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(CriancaLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Criança Lgpd"; form.Show(); }
            if (modelocrud.Modelos.OfType<CriancaLgpd             >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(VisitanteLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Visitante Lgpd"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_AclamacaoLgpd    >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_AclamacaoLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Aclamação Lgpd"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_BatismoLgpd      >().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_BatismoLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por batismo Lgpd"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_ReconciliacaoLgpd>().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_ReconciliacaoLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Reconciliação Lgpd"; form.Show(); }
            if (modelocrud.Modelos.OfType<Membro_TransferenciaLgpd>().FirstOrDefault() == null) { var form = new ListPessoa(typeof(Membro_TransferenciaLgpd)); form.MdiParent = this.MdiParent; form.Text = "Processando dados - Membro por Transferência Lgpd"; form.Show(); }
        }
