...
{
    public partial class cadastro_visitante : Form
    {
        Pessoa p = new Pessoa();
        string classe_ = string.Empty;

        public cadastro_visitante( Pessoa pessoa, string classe)
        {
            InitializeComponent();
            p = pessoa;
            classe_ = classe;
        ...
        private void cadastro_visitante_Load(object sender, EventArgs e)
        {
