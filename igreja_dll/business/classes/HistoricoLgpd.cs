...
namespace business.classes
{
   ...
   public class HistoricoLgpd : modelocrud
    {
        ...
        {
            Update_padrao = $"update HistoricoLgpd set Data_inicio={Data_inicio.ToString()}, " +
        ...
        {
            Delete_padrao = $"delete from HistoricoLgpd where Id='{id}' ";
        ...
        {
            Select_padrao = "select * from HistoricoLgpd as M";
            if (id != null)
        ...
        {
            Insert_padrao =
        $"insert into HistoricoLgpd (Data_inicio, pessoaid, Falta, Id) " +
        $"values ({Data_inicio.ToString()}, {pessoaid}, {Falta}, IDENT_CURRENT('PessoaLgpd'))";
